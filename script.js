var temp=document.getElementById('temp');
 ...
 var error=document.getElementById('error')
    ...
    if (data.weather[0].main=="Clouds") {
        body_img.src='https://cdn-icons-png.flaticon.com/512/1779/1779940.png'
    }
     else if (data.weather[0].main=='Clear') {
        body_img.src='https://cdn-icons-png.flaticon.com/512/3032/3032746.png'
    }
    else if (data.weather[0].main=='Rain') {
        body_img.src='https://cdn-icons-png.flaticon.com/512/10771/10771912.png'
    }
    else if (data.weather[0].main=='Drizzle') {
        body_img.src='https://cdn-icons-png.flaticon.com/512/7774/7774255.png'
    }
    else if (data.weather[0].main=='Mist') {
        body_img.src='https://cdn-icons-png.flaticon.com/512/3104/3104631.png'
    }
    else if (data.weather[0].main=='Haze') {
        body_img.src='https://cdn-icons-png.flaticon.com/512/1779/1779807.png'
    }
